	...
	<body>
		...
		<table class="table table-bordered" style="width:89%;margin:10px auto;">
			...
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
	            ...
	            <td><a class="btn btn-primary" href="/beehive/index.php/Admin/movie/brief/id/<?php echo ($vo["id"]); ?>">查看</a></td>
	            <td><a class="btn btn-info" href="/beehive/index.php/Admin/movie/addImage/id/<?php echo ($vo["id"]); ?>">添加</a></td>
				<td>					
