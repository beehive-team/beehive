	...
	<body>
		<form class="form-horizontal" style="margin-top:20px;margin-left:120px;" role="form">
		  	<div class="form-group">
		    	...
		    	<div class="col-sm-10">
		      		<input type="text" style="width:30%;" class="form-control" id="inputEmail3" placeholder="请输入电影名">
		    	</div>
		  	</div>
		  	<div class="form-group">
		    	<label for="inputPassword3" class="col-sm-2 control-label">国内上映时间</label>
		    	<div class="col-sm-10">
		      		<input type="text" style="width:30%;" class="form-control" id="inputPassword3" placeholder="输入上映时间">
		    	</div>
		  	</div>
		  	<div class="form-group">
		    	<label for="inputEmail3" class="col-sm-2 control-label">国外上映时间</label>
		    	<div class="col-sm-10">
		      		<input type="text" style="width:30%;" class="form-control" id="inputEmail3" placeholder="输入上映时间">
		    	</div>
		  	</div>
		  	<div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label">导演</label>
			    <div class="col-sm-10">
			      	<input type="text" style="width:30%;" class="form-control" id="inputEmail3" placeholder="请输入导演名">
			    </div>
		  	</div>
		  	<div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label">编剧</label>
			    <div class="col-sm-10">
			      	<input type="text" style="width:30%;" class="form-control" id="inputEmail3" placeholder="请输入编剧">
			    </div>
		  	</div>
		  	<div class="form-group">
		  	...
		  	<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      	<input type="text" style="width:30%;" class="form-control" id="inputEmail3" placeholder="请输入影片年份">
			    </div>
		  	</div>
