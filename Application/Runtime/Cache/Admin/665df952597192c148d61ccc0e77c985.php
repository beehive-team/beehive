	...
	<body>
		...
		<form class="form-inline" role="form" style="margin-left:140px;">
		  	<div class="form-group">
		    	<label class="sr-only">图书名</label>
		  	<input type="text" class="form-control"  placeholder="输入图书名进行查询">
		  	</div>
		...
		<table class="table table-hover" style="width:75%;margin:10px auto;">
            ...
            <tr>
	            <td>1</td>
	            <td><img src="dlam.jpg" alt="" class="img-responsive" alt="Responsive image"></td>
	            <td>哆啦A梦</td>
	            <td>是</td>            
				<td>
